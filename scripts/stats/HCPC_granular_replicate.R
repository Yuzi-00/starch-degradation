...
df1 <- left_join(df, res) %>%
  rename(residual = .resid) %>%
  select(-ID, -Category) %>%
  select(Sample, Well, Amylose_Con, pi_A, pi_B, pi_C, pi_AB_ratio,
         mu_A, mu_B, mu_C, sigma_A, sigma_B, sigma_C, DP6_12, DP13_24, 
         DP25_36, DP37_47, Amylase_Act, Peak_Vis, Trough_Vis,
         Final_Vis, Pasting_Temp, k, h, Xinf, residual) 

df2 <- df1 %>%
  unite("sample", Sample:Well) %>%
...
ggsave("figures/cumulative_screeplot_granular_rep.png", 
       plot = sp,
       width = 25, 
       height = 20, 
       units = "cm") 
...
1# Compute hierarchical clustering on principal components
...
write_csv(hcpc2, "analysis/ncp11/hcpc2_granular_rep.csv")
...
write_csv(hcpc3, "analysis/ncp11/hcpc3_granular_rep.csv")
...
write_csv(hcpc4, "analysis/ncp11/hcpc4_granular_rep.csv")
...
write_csv(hcpc5, "analysis/ncp11/hcpc5_granular_rep.csv")
...
write_csv(hcpc6, "analysis/ncp11/hcpc6_granular_rep.csv")
...
write_csv(hcpc7, "analysis/ncp11/hcpc7_granular_rep.csv")
...
write_csv(hcpc8, "analysis/ncp11/hcpc8_granular_rep.csv")
...
write_csv(hcpc9, "analysis/ncp11/hcpc9_granular_rep.csv")
...
write_csv(hcpc10, "analysis/ncp11/hcpc10_granular_rep.csv")
...
write_csv(hcpc11, "analysis/ncp11/hcpc11_granular_rep.csv")
...
write_csv(hcpc12, "analysis/ncp11/hcpc12_granular_rep.csv")
...
write_csv(hcpc13, "analysis/ncp11/hcpc13_granular_rep.csv")
...
write_csv(hcpc14, "analysis/ncp11/hcpc14_granular_rep.csv")
...
write_csv(hcpc15, "analysis/ncp11/hcpc15_granular_rep.csv")
...
write_csv(hcpc16, "analysis/ncp11/hcpc16_granular_rep.csv")
...
write_csv(hcpc17, "analysis/ncp11/hcpc17_granular_rep.csv")
...
write_csv(hcpc18, "analysis/ncp11/hcpc18_granular_rep.csv")
...
write_csv(hcpc19, "analysis/ncp11/hcpc19_granular_rep.csv")
...
write_csv(hcpc20, "analysis/ncp11/hcpc20_granular_rep.csv")
...
write_csv(hcpc21, "analysis/ncp11/hcpc21_granular_rep.csv")
...
write_csv(hcpc22, "analysis/ncp11/hcpc22_granular_rep.csv")
...
write_csv(hcpc23, "analysis/ncp11/hcpc23_granular_rep.csv")
...
write_csv(hcpc24, "analysis/ncp11/hcpc24_granular_rep.csv")
...
write_csv(hcpc25, "analysis/ncp11/hcpc25_granular_rep.csv")
...
write_csv(hcpc26, "analysis/ncp11/hcpc26_granular_rep.csv")
...
write_csv(hcpc27, "analysis/ncp11/hcpc27_granular_rep.csv")
...
write_csv(hcpc28, "analysis/ncp11/hcpc28_granular_rep.csv")
...
write_csv(hcpc29, "analysis/ncp11/hcpc29_granular_rep.csv")
...
write_csv(hcpc30, "analysis/ncp11/hcpc30_granular_rep.csv")
...
write_csv(r_hcpc_s_all, "analysis/hcpc_scaled_ncp11_granular_rep.csv")
...
write_csv(count, "analysis/ncp11/count_individual_granular_rep.csv")
