...
res.pca <- PCA(df_new, 
               ncp = 6, # explain more than 99% of the variability 
               scale.unit = TRUE, 
               quanti.sup = 1:16, # 16 supplementary variables; 8 active variables 
               graph = FALSE)
...
ggsave("figures/cumulative_screeplot_granular_inverse.png", 
       plot = sp,
       width = 25, 
       height = 20, 
       units = "cm") 
...
write_csv(hcpc2, "analysis/ncp6/hcpc2_granular_inverse.csv")
...
write_csv(hcpc3, "analysis/ncp6/hcpc3_granular_inverse.csv")
...
write_csv(hcpc4, "analysis/ncp6/hcpc4_granular_inverse.csv")
...
write_csv(hcpc5, "analysis/ncp6/hcpc5_granular_inverse.csv")
...
write_csv(hcpc6, "analysis/ncp6/hcpc6_granular_inverse.csv")
...
write_csv(hcpc7, "analysis/ncp6/hcpc7_granular_inverse.csv")
...
write_csv(hcpc8, "analysis/ncp6/hcpc8_granular_inverse.csv")
...
write_csv(hcpc9, "analysis/ncp6/hcpc9_granular_inverse.csv")
...
write_csv(hcpc10, "analysis/ncp6/hcpc10_granular_inverse.csv")
...
write_csv(hcpc11, "analysis/ncp6/hcpc11_granular_inverse.csv")
...
write_csv(hcpc12, "analysis/ncp6/hcpc12_granular_inverse.csv")
...
write_csv(hcpc13, "analysis/ncp6/hcpc13_granular_inverse.csv")
...
write_csv(hcpc14, "analysis/ncp6/hcpc14_granular_inverse.csv")
...
write_csv(hcpc15, "analysis/ncp6/hcpc15_granular_inverse.csv")
...
write_csv(hcpc16, "analysis/ncp6/hcpc16_granular_inverse.csv")
...
hcpc17[is.na(hcpc17)] = "residual"

# save the results

write_csv(hcpc17, "analysis/ncp6/hcpc17_granular_inverse.csv")
...
write_csv(hcpc18, "analysis/ncp6/hcpc18_granular_inverse.csv")
...
write_csv(hcpc19, "analysis/ncp6/hcpc19_granular_inverse.csv")
...
write_csv(hcpc20, "analysis/ncp6/hcpc20_granular_inverse.csv")
