...
df1 <- left_join(df, res) %>%
  ...
  select(-ID, -Category) %>%
  select(Sample, Well, Amylose_Con, SSA, VWM, SWM, B_granule, A_granule, AB_ratio,
         D0.1, D0.5, D0.9, DP6_12, DP13_24, DP25_36, DP37_47, Amylase_Act, Peak_Vis, Trough_Vis,
...
#   select(Sample, Amylose_Con, SSA, VWM, SWM, B_granule, A_granule, AB_ratio,
#          D0.1, D0.5, D0.9, DP6_12, DP13_24, DP25_36, DP37_47, Amylase_Act, Peak_Vis, Trough_Vis,
#          Final_Vis, Pasting_Temp, k, h, Xinf, residual) %>%
#   remove_rownames() %>%
#   column_to_rownames(var = 'Sample') %>%
...
write_csv(hcpc2, "analysis/ncp9/hcpc2_rep.csv")
...
write_csv(hcpc3, "analysis/ncp9/hcpc3_rep.csv")
...
write_csv(hcpc4, "analysis/ncp9/hcpc4_rep.csv")
...
write_csv(hcpc5, "analysis/ncp9/hcpc5_rep.csv")
...
write_csv(hcpc6, "analysis/ncp9/hcpc6_rep.csv")
...
write_csv(hcpc7, "analysis/ncp9/hcpc7_rep.csv")
...
write_csv(hcpc8, "analysis/ncp9/hcpc8_rep.csv")
...
write_csv(hcpc9, "analysis/ncp9/hcpc9_rep.csv")
...
write_csv(hcpc10, "analysis/ncp9/hcpc10_rep.csv")
...
write_csv(hcpc11, "analysis/ncp9/hcpc11_rep.csv")
...
write_csv(hcpc12, "analysis/ncp9/hcpc12_rep.csv")
...
write_csv(hcpc13, "analysis/ncp9/hcpc13_rep.csv")
...
write_csv(hcpc14, "analysis/ncp9/hcpc14_rep.csv")
...
write_csv(hcpc15, "analysis/ncp9/hcpc15_rep.csv")
...
write_csv(hcpc16, "analysis/ncp9/hcpc16_rep.csv")
...
write_csv(hcpc17, "analysis/ncp9/hcpc17_rep.csv")
...
write_csv(hcpc18, "analysis/ncp9/hcpc18_rep.csv")
...
write_csv(hcpc19, "analysis/ncp9/hcpc19_rep.csv")
...
write_csv(hcpc20, "analysis/ncp9/hcpc20_rep.csv")
...
write_csv(r_hcpc_s_all, "analysis/hcpc_scaled_ncp9_rep.csv")
...
ggsave("figures/HCPC/ncp9/ncp9_c8_scal_rep.png", 
       plot = ncp9_c8, 
       width = 30, 
       height = 20,  
       units = "cm") 
...
count <- r_hcpc_s_all %>% 
  select(cluster2:cluster20) %>%
  gather(nbr_cluster, values) %>%
  group_by(nbr_cluster, values) %>%
  count()

write_csv(count, "analysis/ncp9/count_individual_rep.csv")
