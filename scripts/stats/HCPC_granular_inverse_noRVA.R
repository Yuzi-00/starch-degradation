...
# compute PCA on the kinetic parameters

res.pca <- PCA(df_new, 
               ncp = 3, # explain more than 99% of the variability 
               scale.unit = TRUE, 
               quanti.sup = 1:20, # 20 supplementary variables (also including the RVAs); 4 active variables (kinetics: h k Xinf residual)
               graph = FALSE)
...
ggsave("figures/cumulative_screeplot_granular_inverse_noRVA.png", 
       plot = sp,
       width = 25, 
       height = 20, 
       units = "cm") 
...
write_csv(hcpc2, "analysis/ncp3/hcpc2_granular_inverse_noRVA.csv")
...
write_csv(hcpc3, "analysis/ncp3/hcpc3_granular_inverse_noRVA.csv")
...
write_csv(hcpc4, "analysis/ncp3/hcpc4_granular_inverse_noRVA.csv")
...
write_csv(hcpc5, "analysis/ncp3/hcpc5_granular_inverse_noRVA.csv")

# 6 clusters

res.hcpc6 <- HCPC(res.pca, graph = FALSE, 
                  consol = TRUE,
                  nb.clust = 6)
...
hcpc6[is.na(hcpc6)] = "Xinf"

# save the results

write_csv(hcpc6, "analysis/ncp3/hcpc6_granular_inverse_noRVA.csv")

# 7 clusters

res.hcpc7 <- HCPC(res.pca, graph = FALSE, 
                  consol = TRUE,
                  nb.clust = 7)
...
write_csv(hcpc7, "analysis/ncp3/hcpc7_granular_inverse_noRVA.csv")

# 8 clusters

res.hcpc8 <- HCPC(res.pca, graph = FALSE, 
                  consol = TRUE,
                  nb.clust = 8)
...
write_csv(hcpc8, "analysis/ncp3/hcpc8_granular_inverse_noRVA.csv")

# 9 clusters

res.hcpc9 <- HCPC(res.pca, graph = FALSE, 
                  consol = TRUE,
                  nb.clust = 9)
...
write_csv(hcpc9, "analysis/ncp3/hcpc9_granular_inverse_noRVA.csv")

# 10 clusters

res.hcpc10 <- HCPC(res.pca, graph = FALSE, 
                   consol = TRUE,
                   nb.clust = 10)
...
write_csv(hcpc10, "analysis/ncp3/hcpc10_granular_inverse_noRVA.csv")

# 11 clusters

res.hcpc11 <- HCPC(res.pca, graph = FALSE, 
                   consol = TRUE,
                   nb.clust = 11)
...
write_csv(hcpc11, "analysis/ncp3/hcpc11_granular_inverse_noRVA.csv")

# 12 clusters

res.hcpc12 <- HCPC(res.pca, graph = FALSE, 
                   consol = TRUE,
                   nb.clust = 12)
...
write_csv(hcpc12, "analysis/ncp3/hcpc12_granular_inverse_noRVA.csv")

# 13 clusters

res.hcpc13 <- HCPC(res.pca, graph = FALSE, 
                   consol = TRUE,
                   nb.clust = 13)
...
hcpc13[is.na(hcpc13)] = "Xinf"

# save the results

write_csv(hcpc13, "analysis/ncp3/hcpc13_granular_inverse_noRVA.csv")

# 14 clusters

res.hcpc14 <- HCPC(res.pca, graph = FALSE, 
                   consol = TRUE,
                   nb.clust = 14)
...
hcpc14[is.na(hcpc14)] = "Xinf"

# save the results

write_csv(hcpc14, "analysis/ncp3/hcpc14_granular_inverse_noRVA.csv")

# 15 clusters

res.hcpc15 <- HCPC(res.pca, graph = FALSE, 
                   consol = TRUE,
                   nb.clust = 15)
...
hcpc15[is.na(hcpc15)] = "Xinf"

# save the results

write_csv(hcpc15, "analysis/ncp3/hcpc15_granular_inverse_noRVA.csv")

# 16 clusters

res.hcpc16 <- HCPC(res.pca, graph = FALSE, 
                   consol = TRUE,
                   nb.clust = 16)
...
hcpc16[is.na(hcpc16)] = "Xinf"

# save the results

write_csv(hcpc16, "analysis/ncp3/hcpc16_granular_inverse_noRVA.csv")

# 17 clusters

res.hcpc17 <- HCPC(res.pca, graph = FALSE, 
                   consol = TRUE,
                   nb.clust = 17)
...
hcpc17[is.na(hcpc17)] = c("Xinf", "residual")

# save the results

write_csv(hcpc17, "analysis/ncp3/hcpc17_granular_inverse_noRVA.csv")

# 18 clusters

res.hcpc18 <- HCPC(res.pca, graph = FALSE, 
                   consol = TRUE,
                   nb.clust = 18)
...
hcpc18[is.na(hcpc18)] = "residual"

# save the results

write_csv(hcpc18, "analysis/ncp3/hcpc18_granular_inverse_noRVA.csv")

# 19 clusters

res.hcpc19 <- HCPC(res.pca, graph = FALSE, 
                   consol = TRUE,
                   nb.clust = 19)
...
hcpc19[is.na(hcpc19)] = "residual"

# save the results

write_csv(hcpc19, "analysis/ncp3/hcpc19_granular_inverse_noRVA.csv")

# 20 clusters

res.hcpc20 <- HCPC(res.pca, graph = FALSE, 
                   consol = TRUE,
                   nb.clust = 20)
...
hcpc20[is.na(hcpc20)] = "residual"

# save the results

write_csv(hcpc20, "analysis/ncp3/hcpc20_granular_inverse_noRVA.csv")
...
write_csv(r_hcpc_all, "analysis/hcpc_ncp6_granular_inverse.csv")
